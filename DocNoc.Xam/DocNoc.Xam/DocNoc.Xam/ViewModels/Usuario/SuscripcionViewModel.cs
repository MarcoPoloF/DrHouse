...
{
    /// <summary>
    /// Definición de ViewModel: Suscripción (dn-64-3).
    /// </summary>
    public class SuscripcionViewModel : DocNocViewModel
    {
        #region Constructor

        public SuscripcionViewModel(INavigationService nav, IApiService api, ITextService text, IPreferenceService pref, IDialogService dial)
        {
            Navigation = nav;
            DocNocApi = api;
            Preferences = pref;
