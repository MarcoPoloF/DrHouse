...
namespace DocNoc.Xam.Controls
{
    ...
    public class TitleView : Grid
    {
        ...
        public TitleView()
        {
            ...
            var boxView = new BoxView { Color = (Color)Application.Current.Resources["Black"] };
        ...
        private static void OnTitlePropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (!string.IsNullOrEmpty(newText))
            {
                titleView.titleLabel = new Label
                {
                    ...
                    FontFamily = Device.RuntimePlatform == Device.Android ? "Poppins-SemiBold.ttf#Poppins-SemiBold"
                            : Device.RuntimePlatform == Device.iOS ? "Poppins-SemiBold"
                            : "Assets/Poppins-SemiBold.ttf#Poppins-SemiBold",
